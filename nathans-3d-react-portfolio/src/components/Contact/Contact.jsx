...
const Contact = () => {
    ...
    const sendEmail = (e) => {
            e.preventDefault()
            emailjs.sendForm('service_g0wiuth', 'template_uqx6nxo', form.current, 'qHgUkb9IVQQ_T5zMb')
              .then((result) => {
    ...
    <div className="mb-20" id="contact" >
      <div className="md:w-10/12 w-11/12 mx-auto ">
        ...
        <div className="md:w-8/12 w-full mx-auto">
            ...
            <p className='text-xl text-neutral-200 mb-5'>My Email: <span className='italic text-sm text-neutral-400'>nate21170@gmail.com</span></p>
