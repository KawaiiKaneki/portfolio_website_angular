...
function Boxes(props) {
  ...
  const textures = [
    useTexture("/images/Js.jpg"),
    useTexture("/images/Css.jpg"),
    useTexture("/images/Html.jpg"),
    useTexture("/images/React.jpg"),
    useTexture("/images/Sql.jpg"),
    useTexture("/images/C.jpg"),
    useTexture("/images/Java.jpg"),
    useTexture("/images/Python.jpg")
  ];
